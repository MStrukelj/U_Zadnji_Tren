...
function Materijali({ onLogout }) {
    ...
    useEffect(() => {
        const fetchMaterials = async () => {
            ...
            try {
                const response = await fetch(`https://backend-latest-in4o.onrender.com/api/predmeti/3/materijali`, {
                    credentials: 'include',
                });
    ...
    const handleUploadClick = async (event) => {
        ...
        try {
            ...
            const response = await fetch(`https://backend-latest-in4o.onrender.com/api/predmeti/3/materijali/upload`, {
                method: "POST",
                body: formData,
                credentials: "include",
            });
