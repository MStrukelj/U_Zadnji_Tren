...
(
    ...
    lozinka VARCHAR NOT NULL,
    PRIMARY KEY (JMBAG),
    FOREIGN KEY (pbrStan) REFERENCES MJESTO(pbr) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (pbrRod) REFERENCES MJESTO(pbr) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (email, lozinka) REFERENCES KORISNIK(email, lozinka) ON DELETE CASCADE ON UPDATE CASCADE,
    UNIQUE (OIB),
...
(
    ...
    FOREIGN KEY (oznRaz) REFERENCES RAZRED(oznRaz) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (sifPredmet) REFERENCES PREDMET(sifPredmet) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (sifNast) REFERENCES NASTAVNIK(sifNast) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT checkoznRaz CHECK(CHAR_LENGTH(oznRaz) < 10)
);
...
(
    ...
    FOREIGN KEY (oznRaz) REFERENCES RAZRED(oznRaz) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (JMBAG) REFERENCES UCENIK(JMBAG) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT checkoznRaz CHECK(CHAR_LENGTH(oznRaz) < 10)
);
...
(
    ...
    FOREIGN KEY (oznUcionica) REFERENCES UCIONICA(oznUcionica) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (sifPredmet) REFERENCES PREDMET(sifPredmet) ON DELETE CASCADE ON UPDATE CASCADE
);
...
(
    ...
    FOREIGN KEY (oznUcionica) REFERENCES UCIONICA(oznUcionica) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (oznRaz, sifPredmet) REFERENCES PREDMETRAZRED(oznRaz, sifPredmet) ON DELETE CASCADE ON UPDATE CASCADE,
